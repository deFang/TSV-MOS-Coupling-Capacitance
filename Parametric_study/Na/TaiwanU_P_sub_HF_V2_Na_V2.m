...
Na=[1.25e20,1.25e21,2.5e21,1.25e22,2.5e22]
adjust=[-0.0415,-0.0415,-0.0465,-0.048,-0.050]
for i=1:5
phiB(i)=0.026*log(Na(i)/ni)+adjust(i);
end
...
F=(0.026*1.6022e-19*Na(par)/dielectSi)*((exp(-fais(i)/0.026)+fais(i)/0.026-1)+(ni^2/Na(par)^2)*(exp(fais(i)/0.026)-fais(i)/0.026+1));
