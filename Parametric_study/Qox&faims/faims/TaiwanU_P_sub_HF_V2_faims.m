...
% work function of filling materials
faim=[4.05,4.10,4.65,4.67,5.17];
faims=-(faim-(4.05+0.56+phiB));
%Qox=2*faims*cox;
Qox=[0,0,0,0,0];
%Qox=-[1.5523e-12,1.4586e-12,3.7426e-13,3.4152e-13,-4.0206e-13]*2;
Qox=[-8.52e-13,-8.16e-13,-3.058e-13,-2.83e-13,5.36e-13]*2;
%Qox=[0e-13,-3e-13,-8e-13,-13e-13,-1.8e-12];%Qox is the charges in silicon surface
